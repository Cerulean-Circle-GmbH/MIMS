...
def show_banner [] {
  ...
  print $"(ansi green)($ellie.1)  (ansi cyan_bold)Welcome to Web 4.0(ansi reset) \(using Nushell v(version | get version)\)"
  print $"(ansi green)($ellie.2)  (ansi light_blue_bold)RAM (ansi reset)(ansi light_blue)($s_mem.used) / ($s_mem.total)(ansi reset)"
